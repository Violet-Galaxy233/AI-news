...
3. **完整信息**
   - ✅ 包含主语："百度发布..." 而非 "发布..."
   - ✅ 独立完整：不依赖上下文就能理解
   - ⚠️ **时间信息一律放 reasoning**，content 不写「X月X日」——见 DON'T 第 5 条
...
5. **content 里不写「X月X日」具体日期** 🚨
   - ❌ `"content": "OpenAI 4月21日 发布 ChatGPT Images 2.0..."`
   - ❌ `"content": "谷歌 4月22日 在拉斯维加斯开幕..."`
   - ✅ `"content": "OpenAI 发布 ChatGPT Images 2.0..."`
   - ✅ `"content": "谷歌在拉斯维加斯开幕..."`
   - **原因**：简报本身就是"当日"新闻，content 里的日期属冗余；读者看前端卡片时已有顶部日期标签
   - **例外**：事件内部的相对时间点（如 "iOS 27 秋季发布"、"5月6日 前免费"、"10月19日 开庭"）是事件本身的组成部分，保留
   - **日期一律放 reasoning** 作为时效证明（"4月X日 [首发媒体] 首发..."）
...
| 重要性   | 字词范围    | 必含内容                                       |
| -------- | ----------- | ---------------------------------------------- |
| critical | 96-160 词   | 主体 + 事件 + ≥3 个量化 + 背景/原因 + 产业影响 |
| high     | 64-96 词    | 主体 + 事件 + ≥3 个量化 + 简要影响             |
| medium   | 32-64 词    | 主体 + 核心事实 + ≥2 个量化                    |
...
- ✅ **中英空格**：所有中英文交接处有空格
- ✅ **独立完整**：包含主语，不依赖上下文
- ✅ **字词符合**：critical 96-160 / high 64-96 / medium 32-64
